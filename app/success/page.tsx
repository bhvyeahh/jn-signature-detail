...
import { CheckCircle2, ArrowRight, Shield, Calendar } from "lucide-react";
      ...
      >
        ...
        <div className="mb-8 relative flex justify-center">
          ...
          <motion.div 
            ...
            className="w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center relative z-10 shadow-[0_0_40px_rgba(37,99,235,0.6)]"
          >
...
export default function SuccessPage() {
  return (
    <main className="min-h-screen bg-black text-white font-sans flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <Suspense fallback={
        <div className="z-10 text-white font-orbitron animate-pulse italic">
          Verifying Session...
        </div>
      }>
        <SuccessContent />
